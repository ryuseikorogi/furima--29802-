class PayForm
  ...
  def save
    ...
    ShippingAddress.create(shipping_prefecture_id: shipping_prefecture_id, address: address, zip_code: zip_code, city: city, building: building, phone_number: phone_number, purchase_id: purchase.id)
